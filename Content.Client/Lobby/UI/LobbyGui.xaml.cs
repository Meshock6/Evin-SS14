        ...
        public LobbyGui()
        {
            ...
            Boosty.OnPressed += _ =>
                _uriOpener.OpenUri(new Uri(
                    "https://boosty.to/ss14evin"));
            Discord.OnPressed += _ => _uriOpener.OpenUri(new Uri("https://discord.gg/raBkckYcnU"));
            Telegram.OnPressed += _ => _uriOpener.OpenUri(new Uri("https://www.youtube.com/watch?v=dQw4w9WgXcQ"));
