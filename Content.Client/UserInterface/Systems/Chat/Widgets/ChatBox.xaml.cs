...
public partial class ChatBox : UIWidget
{
    ...
    [Dependency] private readonly IConfigurationManager _cfg = default!; // Evin-Tweak, EE - Chat stacking
    [Dependency] private readonly ILocalizationManager _loc = default!; // Evin-Tweak, EE - Chat stacking
    ...
    {
        Contents.Clear();
        _chatStackList = new List<ChatStackData>(_chatStackAmount); // Evin-Tweak, EE - Chat stacking
    ...
    public void AddLine(string message, Color color, int repeat = 0) // Evin-Tweak, EE - Chat stacking - repeatr)
    {
        ...
        var formatted = new FormattedMessage(4); // Evin-Tweak, EE - Chat stacking - up from
    ...
    protected override void Dispose(bool disposing)
    {
        ...
        ChatInput.Input.OnTextChanged -= OnTextChanged;
        ChatInput.ChannelSelector.OnChannelSelect -= OnChannelSelect;
        _cfg.UnsubValueChanged(CCVars.ChatStackLastLines, UpdateChatStack); // Evin-Tweak, EE - Chat stacking
    }
}

// Evin-Tweak, EE - StackChat
